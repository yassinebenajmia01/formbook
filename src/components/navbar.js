...
function Navbar() {
  return (
    <div>
      <div className="flex items-center justify-between py-4 px-6 bg-white">
        ...
        <div className="flex items-center space-x-6">
          <div className="block items-center space-x-2 mr-96 pt-5">
            <a className="text-lg text-black font-semibold size-[13px]">
              Hotline 24/7
            </a>
            <a
              href="tel:(025) 3686 2516"
              className="text-2xl font-[700] text-purple-900 size-[20px]"
            >
              <br />
              (025) 3686 25 16
            </a>
      ...
      {/* Gray line */}
      <div className="h-[1px] bg-gray-300 mt-4 mx-6" />
    </div>
  );
}
